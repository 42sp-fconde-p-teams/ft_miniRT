...
{
	char	*line[] = {"A", "-50.0,0.0,20.0", "0.0,0.0,1.1", "70", NULL};
...
{
	char	*line[] = {"A", "-50.0,0.0,20.0", "0.0,-1.001,0.0", "70", NULL};
...
{
	char	*line[] = {"A", "-50.0,0.0,20.0", "0.0,-1.0,0.0", "181", NULL};
...
{
	char	*line[] = {"A", "-50.0,0.0,20.0", "0.0,-1.0,0.0", "-1", NULL};
