...
int	should_convert_positive_int_string_to_double(void)
{
	double	d_nbr = 0.0;
	char	str[3] = "42";
...
int	should_convert_negative_int_string_to_double(void)
{
	double	d_nbr = 0.0;
	char	str[4] = "-42";
...
int	should_convert_zero_int_string_to_double(void)
{
	double	d_nbr = 0.0;
	char	str[2] = "0";
...
int	main(void)
{
	...
	RUN_TEST(should_convert_positive_int_string_to_double);
	RUN_TEST(should_convert_negative_int_string_to_double);
	RUN_TEST(should_convert_zero_int_string_to_double);
	return (0);
}
